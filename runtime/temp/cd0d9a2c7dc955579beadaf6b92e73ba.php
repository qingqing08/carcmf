...
<form class="layui-form" action="<?php echo url(); ?>" method="post">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="la_id" class="field-type" type="select" lay-filter="type">
                ...
                <?php if(is_array($laboratory_list) || $laboratory_list instanceof \think\Collection || $laboratory_list instanceof \think\Paginator): $i = 0; $__LIST__ = $laboratory_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline upload">
            ...
            <input type="text" style="display: none;" class="upload-input" id="file" name="download" value="">
        </div>
    </div>
