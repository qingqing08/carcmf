...
<form class="layui-form" action="<?php echo url(); ?>" method="post">
    <div class="layui-tab-item layui-show">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="url" lay-verify="required" autocomplete="off" placeholder="请输入链接地址">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline upload">
            <button type="button" name="upload" class="layui-btn layui-btn-primary layui-upload" lay-type="image" lay-data="{ exts:'jpg|png|gif|jpeg|ico', accept:'image'}">请上传食材图</button>
...
<script>
    layui.use(['jquery', 'laydate', 'upload' , 'form'], function() {
        ...
        upload.render({
            elem: '.layui-upload',
            url: '<?php echo url("system/annex/upload?group=supplier&thumb=100x100&water=no"); ?>'
            ,method: 'post'
