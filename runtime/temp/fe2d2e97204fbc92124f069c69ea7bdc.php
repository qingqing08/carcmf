<?php /*a:6:{s:72:"D:\phpStudy\PHPTutorial\WWW\car\application\admin\view\product\edit.html";i:1583398599;s:66:"D:\phpStudy\PHPTutorial\WWW\car\application\admin\view\layout.html";i:1583230533;s:73:"D:\phpStudy\PHPTutorial\WWW\car\application\system\view\block\header.html";i:1565145385;s:71:"D:\phpStudy\PHPTutorial\WWW\car\application\system\view\block\menu.html";i:1565145385;s:71:"D:\phpStudy\PHPTutorial\WWW\car\application\admin\view\block\layui.html";i:1565145386;s:73:"D:\phpStudy\PHPTutorial\WWW\car\application\system\view\block\footer.html";i:1565145385;}*/ ?>
...
<form class="layui-form" action="<?php echo url(); ?>" method="post">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="category_id" class="field-type" type="select" lay-filter="type">
                ...
                <?php if(is_array($category_list) || $category_list instanceof \think\Collection || $category_list instanceof \think\Paginator): $i = 0; $__LIST__ = $category_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['id'] == $info['category_id']): ?>
    ...
    <div class="layui-tab-item layui-show">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" value="<?php echo htmlentities($info['product_name']); ?>" name="product_name" lay-verify="required" autocomplete="off" placeholder="请输入产品名称">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline upload">
            ...
            <input type="hidden" class="upload-input" name="image" value="<?php echo htmlentities($info['image']); ?>">
            <img src="<?php echo htmlentities($info['image']); ?>" style="display:none;border-radius:5px;border:1px solid #ccc" width="36" height="36">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline upload">
            ...
            <input type="text" style="display:none;" class="upload-input" id="video_file" name="video" value="<?php echo htmlentities($info['video']); ?>">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-upload">
            ...
            <input type="hidden" class="upload-input" id="images" name="images" value="<?php echo htmlentities($info['images']); ?>">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline upload">
            ...
            <input type="text" style="display: none;" class="upload-input" id="file" name="file" value="<?php echo htmlentities($info['file']); ?>">
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea class="layui-textarea layui-hide" data-type="content" name="" lay-verify="content" id="content"><?php echo htmlentities($info['content']); ?></textarea>
            <input type="hidden" name="content" value="<?php echo htmlentities($info['content']); ?>" id="content_text">
        </div>
    </div>
...
<script>
    layui.use(['layedit','upload'], function(){
        ...
        upload.render({
            elem: '#upload',
            url: '<?php echo url("system/annex/upload?group=product&thumb=100x100&water=no"); ?>'
            ,method: 'post'
        ...
        upload.render({
            elem: '#test2'
            ,url: '<?php echo url("admin/product/upload_file?type=images"); ?>' //改成您自己的上传接口
            ,multiple: true
            ,before: function(obj){
                //预读本地文件示例，不支持ie8
        ...
        upload.render({
            elem: '#video'
            ,url: '<?php echo url("admin/product/upload_file?type=video"); ?>' //改成您自己的上传接口
            ,accept: 'file' //普通文件
            ,done: function(res){
                layer.msg('上传成功');
        ...
        layedit.set({
            uploadImage: {
                url: '<?php echo url("admin/product/upload?group=product&thumb=200&water=no"); ?>' //接口url
            }
        });
