...
<form class="layui-form" action="<?php echo url(); ?>" method="post">
    <div class="layui-tab-item layui-show">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="url" lay-verify="required" autocomplete="off" placeholder="请输入链接地址" value="<?php echo htmlentities($info['url']); ?>">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline upload">
            ...
            <img src="<?php echo htmlentities($info['image']); ?>" style="display:inline;border-radius:5px;border:1px solid #ccc" width="36" height="36">
        </div>
    </div>
