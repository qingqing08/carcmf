...
<form class="layui-form" action="<?php echo url(); ?>" method="post">
    <div class="layui-tab-item layui-show">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="laboratory_name" lay-verify="required" autocomplete="off" placeholder="请输入实训室名称" value="<?php echo htmlentities($info['laboratory_name']); ?>">
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" class="layui-textarea" name="introduction" style="width: 550px"><?php echo htmlentities($info['introduction']); ?></textarea>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">设置智慧实验室</label>
        <div class="layui-input-block">
            <input type="checkbox" name="is_wisdom" lay-skin="switch" lay-text="是|不是" >
        </div>
    </div>
...
<script>
    layui.use(['layedit','upload'], function(){
        ...
        upload.render({
            elem: '#upload',
            url: '<?php echo url("system/annex/upload?group=laboratory&thumb=100x100&water=no"); ?>'
            ,method: 'post'
        ...
        upload.render({
            elem: '#video'
            ,url: '<?php echo url("admin/laboratory/upload_file?type=video"); ?>' //改成您自己的上传接口
            ,accept: 'file' //普通文件
            ,done: function(res){
                layer.msg('上传成功');
        ...
        upload.render({
            elem: '#test3'
            ,url: '<?php echo url("admin/laboratory/upload_file?type=file"); ?>' //改成您自己的上传接口
            ,accept: 'file' //普通文件
            ,done: function(res){
                layer.msg('上传成功');
                $("#file").val(res.path);
        ...
        layedit.set({
            uploadImage: {
                url: '<?php echo url("admin/laboratory/upload?group=laboratory&thumb=200&water=no"); ?>' //接口url
            }
        });
